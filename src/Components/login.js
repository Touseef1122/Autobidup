...
import Vector102 from '../Assets/Images/Vector102.png'
        ...
        <h2 className='lh'>Login</h2>
         <Form>
          <Form.Group as={Col}  >
            ...
            <Form.Label inline className="mb-2 fp"  >Forgrt Password</Form.Label>
            </Form.Group>
            </Row>
            ...
            <Form.Label className="mb-1"><a href="#login"><b>SignUp</b></a></Form.Label>
            </Form.Group>
            <Form.Group>
            ...
            <Form.Group className="d-grid gap-2">
            <Button variant="outline-dark"><img src={image1}  alt="google"  max-width= "165px"/>Google</Button>
            </Form.Group>            
          </Form.Group>         
         </Form>
        </Col>
