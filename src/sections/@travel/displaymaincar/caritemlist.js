      ...
      try {
        ...
        if (props.filterprice != '' && props.filteryear == '' && props.search === '') {
          ...
          response = await fetch(
            `https://autobidup.pythonanywhere.com/cars/search/?price__gte=${startValue}&price__lte=${endValue}`
          );
          ...
          const [startValue, endValue] = priceValue.split(' to ');
          response = await fetch(
            `https://autobidup.pythonanywhere.com/cars/search/?year__gte=${startValue}&year__lte=${endValue}`
          );
        } else if (props.search !== '' && props.filterprice == '' && props.filteryear == '') {
          console.log('entered search');
          response = await fetch(
            `https://autobidup.pythonanywhere.com/cars/search/?search=${props.search}`
          );
        } else if (props.search !== '' && props.filterprice == '' && props.filteryear != '') {
          ...
          const [startValue, endValue] = priceValue.split(' to ');
          response = await fetch(
            `https://autobidup.pythonanywhere.com/cars/search/?search=${props.search}&year__gte=${startValue}&year__lte=${endValue}`
          );
        } else if (props.search !== '' && props.filterprice != '' && props.filteryear == '') {
          ...
          const [startValue, endValue] = priceValue.split(' to ');
          response = await fetch(
            `https://autobidup.pythonanywhere.com/cars/search/?search=${props.search}&price__gte=${startValue}&price__lte=${endValue}`
          );
        } else if (props.search == '' && props.filterprice != '' && props.filteryear != '') {
          ...
          response = await fetch(
            `https://autobidup.pythonanywhere.com/cars/search/?price__gte=${startValue}&price__lte=${endValue}&year__gte=${start}&year__lte=${end}`
          );
        } else if (props.search != '' && props.filterprice != '' && props.filteryear != '') {
          ...
          const [start, end] = yearValue.split(' to ');
          response = await fetch(
            `https://autobidup.pythonanywhere.com/cars/search/?search=${props.search}&price__gte=${startValue}&price__lte=${endValue}&year__gte=${start}&year__lte=${end}`
          );
        } else {
          setData([]);
          console.log('all worked');
          response = await fetch(
            `https://autobidup.pythonanywhere.com/cars/search/?search=${props.value}`
          );
        }
